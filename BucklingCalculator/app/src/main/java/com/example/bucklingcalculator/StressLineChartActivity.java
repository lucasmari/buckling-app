...
import static com.example.bucklingcalculator.MainActivity.criticalStressByLength;
import static com.example.bucklingcalculator.MainActivity.length;

public class StressLineChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartesian.yAxis(0).title(getString(R.string.stress_axis));
