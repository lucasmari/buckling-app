...
public class SettingsActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
           ...
           /* Preference.OnPreferenceChangeListener changeListener2 = (preference, newValue) -> {
                Toast.makeText(getContext(), preference + " set to " + newValue,
                        Toast.LENGTH_SHORT).show();
                SettingsActivity settingsActivity = new SettingsActivity();
                settingsActivity.switchLanguage(newValue);
                return true;
            };

            DropDownPreference dropDownPreference =
                    findPreference(getString(R.string.drop_down_language_key));
            dropDownPreference.setOnPreferenceChangeListener(changeListener2);*/
        }
    }
